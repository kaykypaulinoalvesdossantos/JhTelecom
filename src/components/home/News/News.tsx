            ...
            <div className="grid grid-cols-3 grid-rows-2 gap-12 max-[1351px]:grid-cols-2 max-sm:grid-cols-1">
                {News.map((news) => (
                    <div key={news.id} className="">
                        <Link href="/noticias" className="rounded-lg  min-h-[630px] max-w-[450px] max-h-[650px] max-md:max-w-[350px] max-md:min-w-[350px] max-sm:max-w-[300px] max-sm:max-h-[300px] max-sm:min-w-[280px] max-sm:min-h-[280px] flex flex-col gap-5 max-sm:gap-2 py-4 px-4 max-lg:items-center bg-[#CDD3D9] shadow-cardNews">
