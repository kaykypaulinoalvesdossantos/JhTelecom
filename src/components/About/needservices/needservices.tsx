...
export default function Needservices(){
    return(
        ...
        <div className="flex flex-col items-center w-3/4 shadow-cardShadow text-center gap-7 py-12 rounded-3xl max-sm:w-full max-sm:rounded-none max-sm:h-full">
            <h3 className="font-bold text-5xl max-lg:text-3xl max-md:text-xl">Precisando dos nosso serviços</h3>
            ...
            <Link href={""} className=""><button className="bg-[#2d52a3] py-4 px-16 text-white font-bold text-2xl rounded-lg shadow-buttonShadow max-md:text-xl max-md:py-3 max-md:px-10 ">Entre em contato</button></Link>
        </div>
        </div>
    )
}