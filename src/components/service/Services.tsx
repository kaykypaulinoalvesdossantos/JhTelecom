    ...
    return(
        <div className="space-y-40 flex flex-col items-center">
            ...
            <div className="space-y-28">
                <div className="gap-36 flex items-center">
                <Image src={serviceimg01} alt={""}/>
                <div className="space-y-12">
                    <h3 className="font-inter text-[#1c3363] text-4xl font-bold">Gerenciamento de Servidor</h3>
            ...
            <div className="space-y-28">
                <div className="gap-36 flex items-center">
                <div className="space-y-12">
                    <h3 className="font-inter text-[#1c3363] text-4xl font-bold">Suporte Técnico Casa Cliente</h3>
                    <p className="font-inter text-xl max-w-xl">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took</p>
                </div>
            ...
            <div className="space-y-28">
                ...
                <div className="space-y-12">
                    <h3 className="font-inter text-[#1c3363] text-4xl font-bold">Suporte Por Telefone</h3>
                    <p className="font-inter text-xl max-w-xl">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took</p>
                </div>
                </div>
            </div>
